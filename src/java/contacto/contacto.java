...
public class contacto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(mailEnvio.send("aprendefacil1020@gmail.com","jdbr10122000",correo,mensajerespuesta, "Contacto de ByteCode y Codytron")&&mailEnvio.send("aprendefacil1020@gmail.com","jdbr10122000","arquilabscorp@gmail.com",mensajeAdmin, "Te estan contactando")){
